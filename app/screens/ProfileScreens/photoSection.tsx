...
import { View, Image, StyleSheet, FlatList, Dimensions, ScrollView } from 'react-native';
...
const CleaningGridScreen = () => {
  return (
    ...
    <View style={styles.row}>
      ...
      <View style={styles.column}>
        <Image
          ...
          style={[styles.largeImage, { width: firstColumnWidth }]}
          resizeMode="cover"
        />
      </View>
    ...
    {/* Second Row (Inverted layout) */}
    <View style={styles.row}>
      {/* First Column with Two Smaller Images */}
      <View style={styles.column}>
        <Image
          source={{ uri: images[3].uri }}
          style={[styles.smallImage, { width: firstColumnWidth, 
            height: screenWidth * 0.7/2, 
      ...
      <View style={styles.column}>
        <Image
          ...
          style={[styles.largeImage, { width: secondColumnWidth }]}
          resizeMode="cover"
        />
      </View>
    </View>
...
export default CleaningGridScreen;
